                ...
                <ScrollView padder style={{ flex: 1, alignContent: 'center', backgroundColor: 'black', padding: 5, }}>
                    ...
                    <View style={[Pagestyles.listContainer, { backgroundColor: "#2b2b2b", marginBottom: 20 }]} >
                        <View style={[{ paddingHorizontal: 1, width: deviceWidth / 1.1 }]}  >
                            <Text numberOfLines={10} ellipsizeMode='tail' style={Pagestyles.cardText}>{value.description} </Text>
...
const Pagestyles = StyleSheet.create({
    ...
    listContainer: { alignSelf: 'center', alignItems: 'center', justifyContent: "flex-start", marginVertical: 10, borderRadius: 7, marginBottom: 7, width: deviceWidth / 1.05, height: deviceWidth / 2, backgroundColor: '#2b2b2b', paddingVertical: 5 },
